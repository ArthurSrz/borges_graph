...
export default function GraphVisualization3D({
  ...
  const setMountRef = (element: HTMLDivElement | null) => {
    console.log('📍 Mount element callback triggered:', !!element)
  ...
  useEffect(() => {
    console.log('🔍 GraphVisualization3D useEffect triggered:', {
    ...
    console.log('🌌 Creating galaxy visualization with', neo4jGraphData.nodes.length, 'nodes')
    ...
    const typeColors = {
      ...
      'Événements': 0x5352ed,      // Blue like blue supergiants
    ...
    console.log('✨ Created 3D sphere nodes with emissive materials')
    ...
    if (links3D.length > 0) {
      ...
      console.log('✨ Created glowing connection lines with additive blending')
    }
      ...
      <div className="h-full flex items-center justify-center text-gray-500">
        <div className="text-center">
          ...
          <p className="text-sm mt-2 opacity-75">
            Préparation de la visualisation 3D
          </p>
        </div>
      </div>
    )
